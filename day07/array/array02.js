...
// .map()
// ** 값을 순차적으로 접근하여 callback 함수의 리턴값을 [새로운 배열]로 반환
// 메서드 체이닝
...
console.log(arr3.find((data)=> data === 5))
...
const result = arr14.reduce((accumlate, current, i, arr) => accumlate + current)
console.log(result)
